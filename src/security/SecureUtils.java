...
public final class SecureUtils implements Serializable{
	...
	private static byte[] salt = new byte[] {0x05, 0x0a, 0x04, 0x054, 0x072, 0x06F, 0x06C, 0x06C, 0x09, 0x0f,0x04, 0x0a, 0x0c, 0x0d, 0x0e, 0x09};
	...
	static public char[] toChar(byte[] ba) { 
	...
	public static void main(String[] args){
		System.out.println(Arrays.toString(getSalt()));
	}
