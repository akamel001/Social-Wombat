...
import security.AES;
import util.UserInterfaceHelper;
...
public final class SysAdminInterface {
	...
	private static final String mCONNECT_SERVERS_MESSAGE_1 ="You have been successfully connected to ";
	private static final String mCONNECT_SERVERS_MESSAGE_2 =" servers.";
	...
	private static void systemHomePage(String messages) {	
		if (hubIsRunning == true) {
		    ...
		    case 5: 
		    	int numConnectedServers = hub.connectServers();
		    	systemHomePage(UserInterfaceHelper.addFormattingAlignLeft(mCONNECT_SERVERS_MESSAGE_1 + numConnectedServers + mCONNECT_SERVERS_MESSAGE_2));
		        break;
		     // Shut down the hub.
		    case 6:
		    	try {
